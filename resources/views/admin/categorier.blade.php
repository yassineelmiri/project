                                                ...
                                                @foreach ($categorier as $categorie)
                                                    <tr
                                                        ...
                                                        <td class="px-3.5 py-2.5 first:pl-5 last:pr-5"><a
                                                                href="#!"
                                                                class="transition-all duration-150 ease-linear text-custom-500 hover:text-custom-600 user-id">#{{ $categorie->id }}</a>
                                                        </td>
                                                        <td class="px-3.5 py-2.5 first:pl-5 last:pr-5">
    ...
    <div id="addUserModal" modal-center
        ...
        <div class="w-screen md:w-[30rem] bg-white shadow rounded-md dark:bg-zink-600">
            ...
            <div class="max-h-[calc(theme('height.screen')_-_180px)] p-4 overflow-y-auto">
                <form action="{{ route('categorier.ajouter') }}" method="POST">
                    @csrf
                    <div class="mb-3">
