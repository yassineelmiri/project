                                    ...
                                    <div class="grid grid-cols-1 gap-5 xl:grid-cols-12">
                                        <div class="relative xl:col-span-2">
                                            <input type="text"
                                                ...
                                                placeholder="Search for titer, type, étage etc..." autocomplete="off">
                                            <i data-lucide="search"
                                    ...
                                    <table
                                        ...
                                        <thead class="text-left">
                                            <tr
                                                ...
                                                <th class="px-3.5 py-2.5 first:pl-5 last:pr-5 font-semibold sort"
                                                    data-sort="place">Nomber de lit</th>
                                                <th class="px-3.5 py-2.5 first:pl-5 last:pr-5 font-semibold sort"
                                                    data-sort="etage">etage</th>
                                                <th class="px-3.5 py-2.5 first:pl-5 last:pr-5 font-semibold sort"
                                                    data-sort="name">description</th>
                                                <th class="px-3.5 py-2.5 first:pl-5 last:pr-5 font-semibold sort"
                                            ...
                                            @foreach ($rooms as $room)
                                                <tr
                                                    ...
                                                    <td class="px-3.5 py-2.5 first:pl-5 last:pr-5"><a href="#!"
                                                            class="transition-all duration-150 ease-linear text-custom-500 hover:text-custom-600 user-id">#{{ $room->id }}</a>
                                                    </td>
                                                    <td class="px-3.5 py-2.5 first:pl-5 last:pr-5">
    ...
    <div id="addUserModal" modal-center
        ...
        <div class="w-screen md:w-[30rem] bg-white shadow rounded-md dark:bg-zink-600">
            ...
            <div class="max-h-[calc(theme('height.screen')_-_180px)] p-4 overflow-y-auto">
                <form class="woocommerce-form woocommerce-form-login login elementor-container elementor-column-gap"
