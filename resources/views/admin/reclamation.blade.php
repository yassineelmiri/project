                                                    ...
                                                    <div>
                                                        <button type="button"
                                                            class="bg-white border-dashed text-custom-500 btn border-custom-500 hover:text-custom-500 hover:bg-custom-50 hover:border-custom-600 focus:text-custom-600 focus:bg-custom-50 focus:border-custom-600 active:text-custom-600 active:bg-custom-50 active:border-custom-600 dark:bg-zink-700 dark:ring-custom-400/20 dark:hover:bg-custom-800/20 dark:focus:bg-custom-800/20 dark:active:bg-custom-800/20"><i
                                                                ...
                                                                class="inline-block size-4"></i> <span
                                        ...
                                        <table
                                            ...
                                            <thead class="text-left">
                                                <tr
                                                    ...
                                                    <th class="px-3.5 py-2.5 first:pl-5 last:pr-5 font-semibold sort"
                                                        data-sort="location">Description</th>
                                                    <th class="px-3.5 py-2.5 first:pl-5 last:pr-5 font-semibold sort"
                                                        data-sort="email">Email de Profile</th>
                                                    <th class="px-3.5 py-2.5 first:pl-5 last:pr-5 font-semibold sort"
                                                        data-sort="phone-number">Date de Envoier</th>
                                                    <th class="px-3.5 py-2.5 first:pl-5 last:pr-5 font-semibold sort"
                                                        data-sort="status">Status</th>
                                                    <th class="px-3.5 py-2.5 first:pl-5 last:pr-5 font-semibold">Action
                                                    </th>
                                                </tr>
                                            </thead>
                                            <tbody class="list">
                                                @foreach ($reclamations as $reclamation)
                                                    <tr
                                                        ...
                                                        <td class="px-3.5 py-2.5 first:pl-5 last:pr-5"><a
                                                                href="#!"
                                                                class="transition-all duration-150 ease-linear text-custom-500 hover:text-custom-600 user-id">#{{ $reclamation->id }}</a>
                                                        </td>
                                                        <td class="px-3.5 py-2.5 first:pl-5 last:pr-5">
                                                            <div class="flex items-center gap-2">
                                                                ...
                                                                <div class="grow">
                                                                    <h6 class="mb-1"><a href="#!"
                                                                            class="name">{{ $reclamation->description }}</a></h6>
                                                                    
                                                                </div>
                                                            </div>
                                                        </td>
                                                        <td class="px-3.5 py-2.5 first:pl-5 last:pr-5 location">
                                                            {{ $reclamation->email }}</td>
                                                            <td class="px-3.5 py-2.5 first:pl-5 last:pr-5 location">
                                                                {{ $reclamation->created_at }}</td>
                                                        <td class="px-3.5 py-2.5 first:pl-5 last:pr-5"><span
                                                                class="px-2.5 py-0.5 text-xs font-medium rounded border bg-green-100 border-transparent text-green-500 dark:bg-green-500/20 dark:border-transparent inline-flex items-center status"><i
                                                                    ...
                                                                    class="size-3 mr-1.5"></i> Verified</span></td>
                                                        <td class="px-3.5 py-2.5 first:pl-5 last:pr-5">
                                                            <div class="relative dropdown">
                                                                ...
                                                                <ul class="absolute z-50 hidden py-2 mt-1 ltr:text-left rtl:text-right list-none bg-white rounded-md shadow-md dropdown-menu min-w-[10rem] dark:bg-zink-600"
                                                                    ...
                                                                    <li>
                                                                        <form action="{{ route('auth.destroy', $reclamation->id) }}" method="POST">
                                                                            @method('DELETE')
                                                                            @csrf    
                                                                            <input type="hidden" name="user" value="{{$reclamation->id}}">
                                                                            <button data-modal-target="deleteModal" onclick="return confirm('Vouler vous vraiment supprimer')"
                                                                            class="block px-4 py-1.5 text-base transition-all duration-200 ease-linear text-slate-600 dropdown-item hover:bg-slate-100 hover:text-slate-500 focus:bg-slate-100 focus:text-slate-500 dark:text-zink-100 dark:hover:bg-zink-500 dark:hover:text-zink-200 dark:focus:bg-zink-500 dark:focus:text-zink-200"
                                                                             type="submit"><i data-lucide="trash-2"
                                                                                class="inline-block size-3 ltr:mr-1 rtl:ml-1"></i>
                                                                            <span
                                        ...
                                        <div class="noresult" style="display: none">
                                            <div class="py-6 text-center">
                                                ...
                                                <p class="mb-0 text-slate-500 dark:text-zink-200">We've searched more
                                                    than 199+ users We did not find any users for you search.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="flex flex-col items-center mt-8 md:flex-row">
                                        <div class="mb-4 grow md:mb-0">
                                            <p class="text-slate-500 dark:text-zink-200">Showing <b>10</b> of <b>57</b>
                                                Results</p>
                                        </div>
