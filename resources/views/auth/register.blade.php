...
<head>
    ...
    <title>Create Account &#8211; CozyStay Apartment</title>
...
<body
            ...
            <header class="page-title-large page-title-section">
                ...
                <div class="container">
                    <nav class="woocommerce-breadcrumb" aria-label="Breadcrumb"><a
                            href="https://cozystay.loftocean.com/apartment">Home</a>&nbsp;&#47;&nbsp;Create Account
                    </nav>
                                    ...
                                    <form class="woocommerce-form woocommerce-form-login login"
                                        ...
                                        <p
                                            ...
                                            <input class="woocommerce-Input woocommerce-Input--text input-text"
                                                type="date" name="date" id="date" autocomplete="date" />
                                        </p>
                                        <p
                                            class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
                                        ...
                                        <p
                                            class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
                                            <label for="password">Confirmer Password&nbsp;<span
                                                    class="required">*</span></label>
                                            <input class="woocommerce-Input woocommerce-Input--text input-text"
                                        ...
                                        <p
                                            class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
                                            <input class="woocommerce-Input woocommerce-Input--text input-text"
                                                type="hidden" name="role" id="email" autocomplete="role"
                                                value="client" />
                                        </p>
                                        ...
                                        <p class="form-row">
                                            <button type="submit"
                                                class="woocommerce-button button woocommerce-form-login__submit">Valider</button>
                                        </p>
                                    </form>
    ...
    <script type="application/ld+json">{"@context":"https:\/\/schema.org\/","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"item":{"name":"Home","@id":"https:\/\/cozystay.loftocean.com\/apartment"}},{"@type":"ListItem","position":2,"item":{"name":"Create Account","@id":"https:\/\/cozystay.loftocean.com\/apartment\/my-account\/"}}]}</script>
    <script type='text/javascript'>
        (function() {
