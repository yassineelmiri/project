...
<body
            ...
            <header class="page-title-large page-title-section">
                ...
                <div class="container">
                    <nav class="woocommerce-breadcrumb" aria-label="Breadcrumb"><a
                            href="https://cozystay.loftocean.com/apartment">Home</a>&nbsp;&#47;&nbsp;My account</nav>
                                ...
                                <div class="woocommerce">
                                    ...
                                    <form class="woocommerce-form woocommerce-form-login login"
                                        ...
                                        <p
                                            ...
                                            <label for="email">Username or email address&nbsp;<span
                                        ...
                                        <p class="form-row">
                                            <label
                                                ...
                                                <input class="woocommerce-form__input woocommerce-form__input-checkbox"
                                                    type="checkbox" id="rememberme" value="forever" /> <span>Remember
                                                    me</span>
                                            </label>
                                            <button type="submit"
                                        ...
                                        <p class="woocommerce-LostPassword lost_password">
                                            <a href="{{ route('auth.create') }}">* Register New</a>
                                        </p>
                                        <p class="woocommerce-LostPassword lost_password">
                                            <a href="{{ route('auth.show',"lost-password") }}">* Lost your password?</a>
                                        </p>
    ...
    <script type="application/ld+json">{"@context":"https:\/\/schema.org\/","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"item":{"name":"Home","@id":"https:\/\/cozystay.loftocean.com\/apartment"}},{"@type":"ListItem","position":2,"item":{"name":"My account","@id":"https:\/\/cozystay.loftocean.com\/apartment\/my-account\/"}}]}</script>
    <script type='text/javascript'>
        (function() {
