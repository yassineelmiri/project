...
<link rel="alternate" type="text/xml+oembed" href="../wp-json/oembed/1.0/embede49b?url=https%3A%2F%2Fcozystay.loftocean.com%2Fapartment%2Fmy-account%2F&amp;format=xml" />
	...
	<body class="page page-id-1621 wp-custom-logo wp-embed-responsive theme-cozystay woocommerce-account woocommerce-page woocommerce-no-js elementor-default elementor-kit-5 page-template-default dark-color site-layout-fullwidth cs-form-square">
				<div id="page">
			...
			<div class="elementor-widget-wrap elementor-element-populated">
				...
				<div class="elementor-widget-container">
				    ...
				    <header class="page-title-large page-title-section">
        					<div class="page-title-bg page-title-default-background-image" style="background-size: cover; background-position: center center; background-repeat: no-repeat; background-attachment: scroll; background-image: url(../wp-content/uploads/sites/6/2023/08/jean-philippe-delberghe-xrjusFfOksI-unsplash-3.jpg);" data-loftocean-image="1" data-loftocean-normal-image="https://cozystay.loftocean.com/apartment/wp-content/uploads/sites/6/2023/08/jean-philippe-delberghe-xrjusFfOksI-unsplash-3.jpg" data-loftocean-retina-image="https://cozystay.loftocean.com/apartment/wp-content/uploads/sites/6/2023/08/jean-philippe-delberghe-xrjusFfOksI-unsplash-3.jpg" ></div>         <div class="container"><nav class="woocommerce-breadcrumb" aria-label="Breadcrumb"><a href="https://cozystay.loftocean.com/apartment">Home</a>&nbsp;&#47;&nbsp;My account</nav>            <h1 class="entry-title">My account</h1>
        </div>
            </header>
<div class="main">
	<div class="container">
    ...
    <div class="entry-content"><div class="woocommerce"><div class="woocommerce-notices-wrapper"></div>
		...
		<form class="woocommerce-form woocommerce-form-login login" method="post">
			...
			<p class="form-row">
				...
				<input type="hidden" id="woocommerce-login-nonce" name="woocommerce-login-nonce" value="fc31278c5e" /><input type="hidden" name="_wp_http_referer" value="/apartment/my-account/" />				<button type="submit" class="woocommerce-button button woocommerce-form-login__submit" name="login" value="Log in">Log in</button>
			</p>
...
</p></div><label style="display: none !important;">Leave this field empty if you're human: <input type="text" name="_mc4wp_honeypot" value="" tabindex="-1" autocomplete="off" /></label><input type="hidden" name="_mc4wp_timestamp" value="1710957519" /><input type="hidden" name="_mc4wp_form_id" value="7" /><input type="hidden" name="_mc4wp_form_element_id" value="mc4wp-form-1" /><div class="mc4wp-response"></div></form><!-- / Mailchimp for WordPress Plugin -->		</div>
				</div>
					</div>
		</div>
					</div>
